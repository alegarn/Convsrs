...
class ConvsrsSupabaseUser extends BaseAuthUser {
  ConvsrsSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> convsrsSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = ConvsrsSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
